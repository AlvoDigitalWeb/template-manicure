      ...
      <div className="bg-surface/90 backdrop-blur-xl border border-white/50 shadow-[0_15px_60px_rgba(0,0,0,0.12)] rounded-[2.5rem] overflow-hidden p-8 md:p-10 max-w-5xl mx-auto ring-1 ring-black/[0.03]">
        <div className="flex flex-col lg:flex-row gap-8 items-start lg:items-center">
          ...
          <div className="flex-1 space-y-3">
            ...
            <Text size="sm" color="muted" className="leading-relaxed opacity-90">
            ...
            <button
              ...
              className="hidden lg:flex items-center gap-2 text-[10px] sm:text-xs font-bold uppercase tracking-[0.15em] text-primary/40 hover:text-accent transition-all duration-300 group cursor-pointer"
            >
          ...
          <div className="flex flex-col sm:flex-row lg:flex-col gap-4 w-full md:w-auto min-w-[220px]">
            ...
            <div className="flex gap-3 w-full order-2 sm:order-2 lg:order-2">
              ...
              <Button
                variant="outline"
                size="sm"
                className="lg:hidden flex-1 border-primary/10 text-primary/60 hover:bg-primary/5 hover:text-primary transition-all h-12 text-xs font-bold px-2 sm:px-4"
                onClick={() => setIsModalOpen(true)}
                radius="full"
              >
                Gerir Preferências
